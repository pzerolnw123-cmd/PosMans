...
export type OwnerSectionKey = "sales" | "payments" | "receipts" | "reports" | "menu" | "overview" | "calculator" | "profile" | "plan" | "line" | "settings";
...
const sectionMeta: Record<OwnerSectionKey, { label: string; href: string }> = {
  ...
  plan: { label: "แผน / Plan", href: "/owner/plan" },
...
const sectionIcons: Partial<Record<OwnerSectionKey, ReactNode>> = {
  ...
  plan: (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" aria-hidden="true">
      <g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.6">
        <path d="M4.5 6.5h15m-13 4h11m-9 4h7" />
...
export async function OwnerWorkspace({ session, paymentStore, ownerPlan = null, activeSection }: OwnerWorkspaceProps) {
  ...
  const shell = (
    <BackofficeShell
      ...
      sidebarAction={
        <div
          className={`hidden ${ipadAirOnlyClass} mt-1 border-t border-t-[var(--border)] px-[2px] pb-2 pt-2 [@media(width:1366px)_and_(height:768px)_and_(orientation:landscape)]:mt-0 [@media(width:1366px)_and_(height:768px)_and_(orientation:landscape)]:pb-1 [@media(width:1366px)_and_(height:768px)_and_(orientation:landscape)]:pt-1 [@media(width:1280px)_and_(height:720px)_and_(orientation:landscape)]:mt-0 [@media(width:1280px)_and_(height:720px)_and_(orientation:landscape)]:pb-1 [@media(width:1280px)_and_(height:720px)_and_(orientation:landscape)]:pt-1 [@media(width:1366px)_and_(height:720px)_and_(orientation:landscape)]:mt-0 [@media(width:1366px)_and_(height:720px)_and_(orientation:landscape)]:pb-1 [@media(width:1366px)_and_(height:720px)_and_(orientation:landscape)]:pt-1 [@media(width:1440px)_and_(height:900px)_and_(orientation:landscape)]:!block [@media(width:1440px)_and_(height:900px)_and_(orientation:landscape)]:!mt-auto [@media(width:1440px)_and_(height:900px)_and_(orientation:landscape)]:px-0 [@media(width:1440px)_and_(height:900px)_and_(orientation:landscape)]:pb-1 [@media(width:1440px)_and_(height:900px)_and_(orientation:landscape)]:pt-[14px] [@media(width:1600px)_and_(height:900px)_and_(orientation:landscape)]:!block [@media(width:1600px)_and_(height:900px)_and_(orientation:landscape)]:!mt-auto [@media(width:1600px)_and_(height:900px)_and_(orientation:landscape)]:px-0 [@media(width:1600px)_and_(height:900px)_and_(orientation:landscape)]:pb-1 [@media(width:1600px)_and_(height:900px)_and_(orientation:landscape)]:pt-[14px]`}
        >
          <LogoutButton className="w-full justify-center whitespace-nowrap px-3 py-2 text-[0.88rem] min-h-[36px] [@media(width:1366px)_and_(height:768px)_and_(orientation:landscape)]:min-h-[34px] [@media(width:1366px)_and_(height:768px)_and_(orientation:landscape)]:py-1.5 [@media(width:1280px)_and_(height:720px)_and_(orientation:landscape)]:min-h-[34px] [@media(width:1280px)_and_(height:720px)_and_(orientation:landscape)]:py-1.5 [@media(width:1366px)_and_(height:720px)_and_(orientation:landscape)]:min-h-[34px] [@media(width:1366px)_and_(height:720px)_and_(orientation:landscape)]:py-1.5 [@media(width:1440px)_and_(height:900px)_and_(orientation:landscape)]:!mt-0 [@media(width:1440px)_and_(height:900px)_and_(orientation:landscape)]:!min-h-[40px] [@media(width:1440px)_and_(height:900px)_and_(orientation:landscape)]:!rounded-[8px] [@media(width:1440px)_and_(height:900px)_and_(orientation:landscape)]:!bg-[var(--panel-subtle)] [@media(width:1440px)_and_(height:900px)_and_(orientation:landscape)]:!py-2 [@media(width:1600px)_and_(height:900px)_and_(orientation:landscape)]:!mt-0 [@media(width:1600px)_and_(height:900px)_and_(orientation:landscape)]:!min-h-[40px] [@media(width:1600px)_and_(height:900px)_and_(orientation:landscape)]:!rounded-[8px] [@media(width:1600px)_and_(height:900px)_and_(orientation:landscape)]:!bg-[var(--panel-subtle)] [@media(width:1600px)_and_(height:900px)_and_(orientation:landscape)]:!py-2" />
        </div>
      }
