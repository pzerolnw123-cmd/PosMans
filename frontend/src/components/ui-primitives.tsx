...
export function PageHeader({
  ...
  return (
    <>
      ...
      <ProfileHeaderInjector className={`hidden [@media(max-width:1366px)_and_(any-pointer:coarse)]:flex ${tabletInjectedHeaderClass} ${ipadAirOnlyHideClass} ${laptop1366HeaderHideClass} ${className}`.trim()} />
    </>
  );
}
