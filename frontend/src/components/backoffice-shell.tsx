...
const sidebarHeaderClass =
  "border-b border-b-[var(--border)] px-[10px] pb-[18px] pt-[14px] [@media(width:1366px)_and_(height:768px)_and_(orientation:landscape)]:pb-[10px] [@media(width:1366px)_and_(height:768px)_and_(orientation:landscape)]:pt-[10px] [@media(min-width:768px)_and_(max-width:820px)_and_(orientation:portrait)_and_(any-pointer:coarse)]:pb-[12px] [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:pb-[12px] [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:pb-[12px]";
      ...
      >
        <div className="relative grid max-h-full min-h-0 content-start gap-[14px] overflow-hidden [@media(orientation:portrait)]:max-h-none [@media(orientation:portrait)]:gap-4 [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:!max-h-full [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:gap-[10px] max-[1280px]:max-h-none max-[820px]:gap-4">
          ...
          {shellAlert ? (
            ...
            >
              <p
                className={`m-0 text-[0.72rem] font-bold uppercase tracking-[0.24em] [@media(width:1366px)_and_(height:768px)_and_(orientation:landscape)]:text-[0.62rem] [@media(width:1366px)_and_(height:768px)_and_(orientation:landscape)]:tracking-[0.18em] ${shellAlert.tone === "success"
              ...
              <p
                className={`mt-2 text-[0.95rem] leading-[1.55] [@media(width:1366px)_and_(height:768px)_and_(orientation:landscape)]:mt-1.5 [@media(width:1366px)_and_(height:768px)_and_(orientation:landscape)]:text-[0.82rem] [@media(width:1366px)_and_(height:768px)_and_(orientation:landscape)]:leading-[1.35] ${shellAlert.tone === "success" ? successAlertMessageClass : shellAlert.tone === "info" ? "text-[var(--foreground)]" : dangerAlertMessageClass
                  }`}
              >
                {shellAlert.message}
              </p>
