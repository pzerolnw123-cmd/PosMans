...
const sidebarHeaderClass =
  "border-b border-b-[var(--border)] px-[10px] pb-[18px] pt-[14px] [@media(width:1366px)_and_(height:768px)_and_(orientation:landscape)]:pb-[10px] [@media(width:1366px)_and_(height:768px)_and_(orientation:landscape)]:pt-[10px] [@media(width:1280px)_and_(height:720px)_and_(orientation:landscape)]:pb-[10px] [@media(width:1280px)_and_(height:720px)_and_(orientation:landscape)]:pt-[10px] [@media(min-width:768px)_and_(max-width:820px)_and_(orientation:portrait)_and_(any-pointer:coarse)]:pb-[12px] [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:pb-[12px] [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:pb-[12px]";
...
const sidebarActiveLinkClass =
  "inline-flex min-h-[48px] items-center gap-3 rounded-xl border border-[var(--accent-border)] [background:var(--brand-gradient)] px-[18px] py-3 font-semibold text-[var(--button-text)] shadow-[var(--brand-shadow)_0_8px_18px] [@media(width:1366px)_and_(height:768px)_and_(orientation:landscape)]:min-h-[44px] [@media(width:1366px)_and_(height:768px)_and_(orientation:landscape)]:px-[14px] [@media(width:1366px)_and_(height:768px)_and_(orientation:landscape)]:py-[7px] [@media(width:1280px)_and_(height:720px)_and_(orientation:landscape)]:!min-h-[44px] [@media(width:1280px)_and_(height:720px)_and_(orientation:landscape)]:!px-[14px] [@media(width:1280px)_and_(height:720px)_and_(orientation:landscape)]:!py-[7px] [@media(min-width:768px)_and_(max-width:820px)_and_(orientation:portrait)_and_(any-pointer:coarse)]:min-h-[41px] [@media(min-width:768px)_and_(max-width:820px)_and_(orientation:portrait)_and_(any-pointer:coarse)]:px-[15px] [@media(min-width:768px)_and_(max-width:820px)_and_(orientation:portrait)_and_(any-pointer:coarse)]:py-[10px] [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:min-h-[38px] [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:min-h-[41px] [@media(min-width:1181px)_and_(max-width:1366px)_and_(max-height:999px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:min-h-[42px] [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:px-[12px] [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:px-[15px] [@media(min-width:1181px)_and_(max-width:1366px)_and_(max-height:999px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:px-[16px] [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:py-[8px] [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:py-[10px] [@media(min-width:1181px)_and_(max-width:1366px)_and_(max-height:999px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:py-[9px] max-[640px]:min-h-[44px] max-[640px]:px-[14px] max-[640px]:py-2.5";
const sidebarInactiveLinkClass =
  "inline-flex min-h-[48px] items-center gap-3 rounded-xl px-[18px] py-3 font-semibold text-[var(--foreground)] transition duration-150 hover:translate-x-[2px] hover:bg-[var(--brand-soft)] [@media(width:1366px)_and_(height:768px)_and_(orientation:landscape)]:min-h-[44px] [@media(width:1366px)_and_(height:768px)_and_(orientation:landscape)]:px-[14px] [@media(width:1366px)_and_(height:768px)_and_(orientation:landscape)]:py-[7px] [@media(width:1280px)_and_(height:720px)_and_(orientation:landscape)]:!min-h-[44px] [@media(width:1280px)_and_(height:720px)_and_(orientation:landscape)]:!px-[14px] [@media(width:1280px)_and_(height:720px)_and_(orientation:landscape)]:!py-[7px] [@media(min-width:768px)_and_(max-width:820px)_and_(orientation:portrait)_and_(any-pointer:coarse)]:min-h-[41px] [@media(min-width:768px)_and_(max-width:820px)_and_(orientation:portrait)_and_(any-pointer:coarse)]:px-[15px] [@media(min-width:768px)_and_(max-width:820px)_and_(orientation:portrait)_and_(any-pointer:coarse)]:py-[10px] [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:min-h-[38px] [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:min-h-[41px] [@media(min-width:1181px)_and_(max-width:1366px)_and_(max-height:999px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:min-h-[42px] [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:px-[12px] [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:px-[15px] [@media(min-width:1181px)_and_(max-width:1366px)_and_(max-height:999px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:px-[16px] [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:py-[8px] [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:py-[10px] [@media(min-width:1181px)_and_(max-width:1366px)_and_(max-height:999px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:py-[9px] max-[640px]:min-h-[44px] max-[640px]:px-[14px] max-[640px]:py-2.5";
      ...
      >
        <div className="relative grid max-h-full min-h-0 content-start gap-[14px] overflow-hidden [@media(orientation:portrait)]:max-h-none [@media(orientation:portrait)]:gap-4 [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:!max-h-full [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:gap-[10px] max-[1280px]:max-h-none [@media(width:1280px)_and_(height:720px)_and_(orientation:landscape)]:!max-h-full max-[820px]:gap-4">
          ...
          {shellAlert ? (
            ...
            >
              <p
                className={`m-0 text-[0.72rem] font-bold uppercase tracking-[0.24em] [@media(width:1366px)_and_(height:768px)_and_(orientation:landscape)]:text-[0.62rem] [@media(width:1366px)_and_(height:768px)_and_(orientation:landscape)]:tracking-[0.18em] [@media(width:1280px)_and_(height:720px)_and_(orientation:landscape)]:text-[0.58rem] [@media(width:1280px)_and_(height:720px)_and_(orientation:landscape)]:tracking-[0.16em] ${shellAlert.tone === "success"
              ...
              <p
                className={`mt-2 text-[0.95rem] leading-[1.55] [@media(width:1366px)_and_(height:768px)_and_(orientation:landscape)]:mt-1.5 [@media(width:1366px)_and_(height:768px)_and_(orientation:landscape)]:text-[0.82rem] [@media(width:1366px)_and_(height:768px)_and_(orientation:landscape)]:leading-[1.35] [@media(width:1280px)_and_(height:720px)_and_(orientation:landscape)]:mt-1 [@media(width:1280px)_and_(height:720px)_and_(orientation:landscape)]:text-[0.72rem] [@media(width:1280px)_and_(height:720px)_and_(orientation:landscape)]:leading-[1.25] ${shellAlert.tone === "success" ? successAlertMessageClass : shellAlert.tone === "info" ? "text-[var(--foreground)]" : dangerAlertMessageClass
                  }`}
              >
                {shellAlert.message}
              </p>
