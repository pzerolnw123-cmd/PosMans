  ...
  return (
    <div className={`grid h-full min-h-0 min-w-0 w-full max-w-full grid-cols-[minmax(0,1fr)_320px] items-start gap-[18px] [@media(orientation:portrait)]:h-auto [@media(orientation:portrait)]:grid-cols-1 [@media(orientation:portrait)]:gap-4 ${ownerLandscapeClass}:grid-cols-[minmax(0,1fr)_244px] ${ownerLandscapeClass}:gap-[12px] max-[820px]:grid-cols-1 max-[820px]:gap-4 ${ipadAirLandscapeClass}:items-stretch`}>
      <section className={`grid min-h-0 min-w-0 w-full grid-rows-[auto_auto_minmax(0,1fr)] content-start gap-[18px] ${ownerLandscapeTightGapClass} ${ipadAirLandscapeClass}:h-full ${ipadAirLandscapeClass}:grid-rows-[auto_minmax(0,1fr)]`} aria-label="store overview main area">
        ...
        <div className={`grid min-h-0 w-full grid-cols-[minmax(0,1.1fr)_minmax(300px,0.9fr)] items-start gap-[18px] [@media(orientation:portrait)]:grid-cols-1 [@media(orientation:portrait)]:gap-4 ${ownerLandscapeClass}:gap-[14px] max-[820px]:grid-cols-1 ${ipadAirLandscapeClass}:!grid-cols-1 ${ipadAirLandscapeClass}:items-stretch [@media(min-width:821px)_and_(max-width:1180px)_and_(orientation:landscape)]:!grid-cols-[minmax(0,1fr)] [@media(width:1280px)_and_(height:720px)_and_(orientation:landscape)]:!grid-cols-1 [@media(width:1280px)_and_(height:800px)_and_(orientation:landscape)]:!grid-cols-1`}>
          <section className={`grid min-h-0 w-full max-w-none justify-self-stretch content-start gap-[18px] rounded-none border border-[var(--border)] bg-[var(--panel-strong)] px-5 py-[18px] shadow-[var(--shadow-soft)] ${ownerLandscapePanelPaddingClass} ${ownerLandscapeClass}:gap-[14px] max-[820px]:px-4 max-[820px]:py-4 ${ipadAirLandscapeClass}:h-full ${ipadAirLandscapeClass}:!w-full ${ipadAirLandscapeClass}:content-stretch [@media(min-width:821px)_and_(max-width:1180px)_and_(orientation:landscape)]:!col-span-full [@media(min-width:821px)_and_(max-width:1180px)_and_(orientation:landscape)]:!w-full [@media(min-width:821px)_and_(max-width:1180px)_and_(orientation:landscape)]:!max-w-none [@media(width:1280px)_and_(height:720px)_and_(orientation:landscape)]:!col-span-full [@media(width:1280px)_and_(height:720px)_and_(orientation:landscape)]:!w-full [@media(width:1280px)_and_(height:720px)_and_(orientation:landscape)]:!max-w-none [@media(width:1280px)_and_(height:800px)_and_(orientation:landscape)]:!col-span-full [@media(width:1280px)_and_(height:800px)_and_(orientation:landscape)]:!w-full [@media(width:1280px)_and_(height:800px)_and_(orientation:landscape)]:!max-w-none`} aria-label="store readiness">
          ...
          <section className={`grid content-start gap-[18px] rounded-none border border-[var(--border)] bg-[var(--panel-strong)] px-5 py-[18px] shadow-[var(--shadow-soft)] ${ownerLandscapePanelPaddingClass} ${ownerLandscapeClass}:gap-[14px] max-[820px]:px-4 max-[820px]:py-4 ${ipadAirLandscapeClass}:hidden [@media(min-width:821px)_and_(max-width:1180px)_and_(orientation:landscape)]:!hidden [@media(width:1280px)_and_(height:720px)_and_(orientation:landscape)]:!hidden [@media(width:1280px)_and_(height:800px)_and_(orientation:landscape)]:!hidden`}>
            <div>
