                ...
                >
                  ...
                  <div className="grid min-w-0 gap-1.5 pt-0.5">
                    ...
                    <div className="flex w-full flex-wrap items-center gap-1.5">
                      ...
                      <button
                        type="button"
                        className="ml-auto h-8 shrink-0 rounded-[10px] border border-[var(--danger-soft)] px-2 text-[0.74rem] font-bold text-[var(--danger)] transition hover:bg-[var(--danger-soft)]"
