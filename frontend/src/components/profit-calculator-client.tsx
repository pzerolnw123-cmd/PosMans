      ...
      <section className="grid h-full min-h-0 grid-rows-[auto_auto_minmax(0,1fr)] gap-[18px] overflow-hidden rounded-none border border-[var(--border)] bg-[var(--panel-strong)] px-5 py-5 shadow-[var(--shadow-soft)] [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:gap-3 [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:px-4 [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:py-4 [@media(orientation:portrait)]:h-fit [@media(orientation:portrait)]:overflow-visible [@media(orientation:portrait)]:px-4 [@media(orientation:portrait)]:py-4 max-[820px]:h-fit max-[820px]:overflow-visible max-[820px]:px-4 max-[820px]:py-4">
        <div className="grid grid-cols-[minmax(0,1fr)_minmax(280px,auto)] items-start gap-3 [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:grid-cols-[minmax(0,1fr)_minmax(200px,auto)] [@media(orientation:portrait)]:grid-cols-1 max-[720px]:grid-cols-1">
          <div>
            ...
            <h2 className="my-[7px] text-[clamp(1.5rem,2.4vw,2.25rem)] leading-none tracking-[-0.055em] text-[var(--foreground)] [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:my-[5px] [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:text-[1.42rem]">คำนวณกำไร</h2>
        ...
        <div className="grid h-full min-h-0 grid-rows-[auto_minmax(0,1fr)] rounded-none border border-[var(--border)] bg-[var(--panel-subtle)] p-4 [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:p-3 max-[820px]:h-auto max-[640px]:p-3">
          <div className="mb-3 flex flex-wrap items-center justify-between gap-3 [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:mb-2 [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:gap-2">
            <div>
              <p className="m-0 text-[0.72rem] font-bold uppercase tracking-[0.22em] text-[var(--eyebrow)] [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:text-[0.62rem] [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:tracking-[0.18em]">Product Cost Inputs</p>
              <strong className="mt-1 block text-[1.2rem] leading-tight text-[var(--foreground)] [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:text-[1rem]">ต้นทุนต่อสินค้าที่ขายจริง</strong>
            </div>
            <button type="button" className={`${secondaryButtonClass} [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:min-h-[36px] [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:px-3 [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:text-[0.8rem]`} onClick={resetCosts}>รีเซ็ตต้นทุน</button>
          </div>
          ...
          {loading && !report ? (
            ...
            <div className="relative h-full min-h-[220px] min-w-0 [@media(min-width:768px)_and_(max-width:820px)_and_(orientation:portrait)_and_(any-pointer:coarse)]:pr-5 [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:pr-2.5 [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:pr-5 [@media(min-width:1181px)_and_(max-width:1366px)_and_(max-height:860px)_and_(orientation:landscape)]:pr-1">
              <div
                ref={productScrollRef}
                className={
                  productScrollMetric.visible
                    ? "sales-cart-scroll grid h-full min-h-0 touch-none cursor-grab select-none content-start gap-2 overflow-y-auto overflow-x-hidden pl-0 pr-10 active:cursor-grabbing [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:pr-2.5 [@media(width:1440px)_and_(height:900px)_and_(orientation:landscape)]:!pr-[28px] max-[820px]:max-h-[420px] max-[820px]:min-h-[220px] max-[780px]:max-h-none max-[780px]:touch-auto max-[780px]:select-auto max-[780px]:overflow-visible max-[780px]:pr-0"
                ...
                return (
                  <div key={product.name} className="grid w-[calc(100%-32px)] justify-self-start grid-cols-[minmax(180px,1.35fr)_minmax(118px,0.72fr)_minmax(104px,0.56fr)_minmax(104px,0.56fr)] items-center gap-x-6 gap-y-3 rounded-none border border-[var(--border)] bg-[var(--surface)] px-4 py-3 max-[1180px]:w-full max-[1180px]:grid-cols-[minmax(180px,1fr)_minmax(118px,180px)] [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:!w-full [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:!grid-cols-[minmax(112px,1fr)_minmax(92px,104px)_minmax(54px,64px)_minmax(54px,64px)] [@media(min-width:1181px)_and_(max-width:1366px)_and_(max-height:860px)_and_(orientation:landscape)]:!w-[calc(100%-4px)] [@media(width:1440px)_and_(height:900px)_and_(orientation:landscape)]:!w-full [@media(min-width:1181px)_and_(max-width:1366px)_and_(max-height:860px)_and_(orientation:landscape)]:grid-cols-[minmax(170px,1.22fr)_minmax(108px,0.72fr)_minmax(88px,0.5fr)_minmax(82px,0.46fr)] [@media(min-width:1181px)_and_(max-width:1366px)_and_(max-height:860px)_and_(orientation:landscape)]:gap-x-4 [@media(min-width:1181px)_and_(max-width:1366px)_and_(max-height:860px)_and_(orientation:landscape)]:px-3 [@media(min-width:1181px)_and_(max-width:1366px)_and_(max-height:860px)_and_(orientation:landscape)]:py-2.5 [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:gap-x-2 [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:gap-y-1.5 [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:px-2 [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:py-2 max-[780px]:grid-cols-1 max-[780px]:px-3">
                    ...
                    <label className="grid gap-1 [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:gap-0.5">
                      ...
                      <input
                        className={`${inputClass} h-[40px] [@media(min-width:1181px)_and_(max-width:1366px)_and_(max-height:860px)_and_(orientation:landscape)]:h-[36px] [@media(min-width:1181px)_and_(max-width:1366px)_and_(max-height:860px)_and_(orientation:landscape)]:px-2.5 [@media(min-width:1181px)_and_(max-width:1366px)_and_(max-height:860px)_and_(orientation:landscape)]:text-[0.84rem] [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:h-[34px] [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:px-2 [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:text-[0.8rem]`}
                        inputMode="decimal"
                    ...
                    <div className="min-w-0">
                      <span className="text-[0.72rem] font-bold text-[var(--foreground-soft)] [@media(min-width:1181px)_and_(max-width:1366px)_and_(max-height:860px)_and_(orientation:landscape)]:text-[0.66rem] [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:text-[0.66rem]">ต้นทุนรวม</span>
                      <strong className="mt-1 block text-[var(--foreground)] [@media(min-width:1181px)_and_(max-width:1366px)_and_(max-height:860px)_and_(orientation:landscape)]:text-[0.84rem] [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:mt-0.5 [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:text-[0.82rem]">{formatBaht(totalCost)}</strong>
                    </div>
                    <div className="min-w-0">
                      <span className="text-[0.72rem] font-bold text-[var(--foreground-soft)] [@media(min-width:1181px)_and_(max-width:1366px)_and_(max-height:860px)_and_(orientation:landscape)]:text-[0.66rem] [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:text-[0.66rem]">กำไร</span>
                      <strong className={profit < 0 ? "mt-1 block text-[var(--danger)] [@media(min-width:1181px)_and_(max-width:1366px)_and_(max-height:860px)_and_(orientation:landscape)]:text-[0.84rem] [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:mt-0.5 [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:text-[0.82rem]" : "mt-1 block text-[var(--foreground)] [@media(min-width:1181px)_and_(max-width:1366px)_and_(max-height:860px)_and_(orientation:landscape)]:text-[0.84rem] [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:mt-0.5 [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:text-[0.82rem]"}>{formatBaht(profit)}</strong>
                    </div>
                  </div>
                );
              })}
