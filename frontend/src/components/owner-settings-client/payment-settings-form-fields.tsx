...
const posWideShortRecipientOptionClass =
  "[@media(min-width:1181px)_and_(max-width:1280px)_and_(max-height:720px)_and_(orientation:landscape)]:!flex [@media(min-width:1181px)_and_(max-width:1280px)_and_(max-height:720px)_and_(orientation:landscape)]:!min-h-[34px] [@media(min-width:1181px)_and_(max-width:1280px)_and_(max-height:720px)_and_(orientation:landscape)]:!items-center [@media(min-width:1181px)_and_(max-width:1280px)_and_(max-height:720px)_and_(orientation:landscape)]:!justify-center [@media(min-width:1181px)_and_(max-width:1280px)_and_(max-height:720px)_and_(orientation:landscape)]:!gap-1.5 [@media(min-width:1181px)_and_(max-width:1280px)_and_(max-height:720px)_and_(orientation:landscape)]:!px-3 [@media(min-width:1181px)_and_(max-width:1280px)_and_(max-height:720px)_and_(orientation:landscape)]:!py-1 [@media(min-width:1181px)_and_(max-width:1280px)_and_(max-height:720px)_and_(orientation:landscape)]:!text-center [@media(width:1366px)_and_(height:720px)_and_(orientation:landscape)]:!flex [@media(width:1366px)_and_(height:720px)_and_(orientation:landscape)]:!min-h-[34px] [@media(width:1366px)_and_(height:720px)_and_(orientation:landscape)]:!items-center [@media(width:1366px)_and_(height:720px)_and_(orientation:landscape)]:!justify-center [@media(width:1366px)_and_(height:720px)_and_(orientation:landscape)]:!gap-1.5 [@media(width:1366px)_and_(height:720px)_and_(orientation:landscape)]:!px-3 [@media(width:1366px)_and_(height:720px)_and_(orientation:landscape)]:!py-1 [@media(width:1366px)_and_(height:720px)_and_(orientation:landscape)]:!text-center";
