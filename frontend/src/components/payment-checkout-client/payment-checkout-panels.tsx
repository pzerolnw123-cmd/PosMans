...
export function PaymentCheckoutPanels({
    ...
    return (
      <>
        ...
        <div className="grid min-w-0 gap-1">
          <strong className={`truncate text-base leading-[1.2] text-[var(--foreground)] ${ownerLandscapeClass}:text-[0.95rem] [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:!text-[0.78rem]`}>{item.name}</strong>
  ...
  return (
    <>
      ...
      <div className="contents [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:col-span-2 [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:col-span-2 [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:col-start-2 [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:col-start-2 [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:grid [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:grid [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:h-full [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:h-full [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:min-h-0 [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:min-h-0 [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:grid-rows-[minmax(0,1fr)_auto] [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:grid-rows-[minmax(0,1fr)_auto] [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:gap-3 [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:gap-3">
      <section className={`${paymentPanelClass} [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:h-full [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:h-full [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:min-h-0 [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:min-h-0`}>
        <div className="[@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:grid [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:grid [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:grid-cols-[minmax(0,1fr)_minmax(0,1fr)] [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:grid-cols-[minmax(0,1fr)_minmax(0,1fr)] [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:items-start [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:items-start [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:gap-3 [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:gap-3">
          ...
          <p className="m-0 text-[0.95rem] leading-[1.65] text-[var(--foreground-soft)] [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:hidden">
            {completedSale ? "บิลนี้ชำระสำเร็จแล้ว" : "เลือกวิธีรับเงินก่อนบันทึกบิลจริง"}
          </p>
          </div>
          {customerDisplayControl ? (
            <div className="hidden min-w-0 [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:block [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:block">
              {customerDisplayControl}
            </div>
          ) : null}
        </div>
        ...
        <div className={`grid content-start gap-4 ${ownerLandscapeClass}:gap-3 [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:gap-2.5`}>
          <div className={`grid grid-cols-2 gap-3 ${ownerLandscapeClass}:gap-2.5 [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:grid-cols-3 max-[860px]:grid-cols-1 [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:!grid-cols-3`}>
        ...
        <div className="grid grid-cols-2 gap-3 [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:gap-2.5 max-[860px]:grid-cols-1 [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:!grid-cols-2">
          <button type="button" className={`${secondaryButtonClass} min-h-[52px] rounded-2xl [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:min-h-[50px]`} onClick={onBackToSales}>
            {completedSale ? "เปิดออเดอร์ใหม่" : "กลับไปขาย"}
          </button>
          <button
            type="button"
            className={`${primaryButtonClass} min-h-[52px] rounded-2xl [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:min-h-[50px]`}
      ...
      <section className={`${quickPanelClass} ${ownerLandscapeClass}:col-span-1 max-[820px]:px-4 max-[820px]:py-4 ${!completedSale && transferSelected ? "[@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:relative [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:relative [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:gap-[10px] [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:gap-[10px] [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:px-2.5 [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:px-2.5 [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:py-2.5 [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:py-2.5" : ""} ${!completedSale && qrPaymentSelected ? "[@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:relative [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:relative" : ""}`}>
        <div className={!completedSale && transferSelected ? "[@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:min-h-[44px] [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:min-h-[44px] [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:pr-[92px] [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:pr-[92px] [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:[&>strong]:text-[0.92rem] [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:[&>strong]:text-[0.92rem] [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:[&>strong]:whitespace-nowrap [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:[&>strong]:whitespace-nowrap" : undefined}>
          <p className="m-0 text-[0.72rem] font-bold uppercase tracking-[0.28em] text-[var(--eyebrow)] [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:whitespace-nowrap [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:whitespace-nowrap">Quick Panel</p>
          <strong className={`my-[10px] block text-[1.28rem] leading-tight tracking-[-0.04em] text-[var(--foreground)] ${ownerLandscapeClass}:text-[1.16rem] [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:my-[8px] [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:my-[8px] [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:text-[1.05rem] [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:text-[1.05rem]`}>สถานะชำระเงิน</strong>
        </div>
        {!completedSale && transferSelected ? (
          <div className="hidden [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:absolute [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:absolute [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:right-2.5 [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:right-2.5 [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:top-2.5 [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:top-2.5 [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:grid [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:grid [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:justify-items-end [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:justify-items-end [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:gap-0.5 [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:gap-0.5 [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:text-right [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:text-right">
          ...
          <div className="hidden [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:absolute [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:absolute [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:right-3 [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:right-3 [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:top-2.5 [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:top-2.5 [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:grid [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:grid [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:justify-items-end [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:justify-items-end [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:gap-0.5 [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:gap-0.5 [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:text-right [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:text-right">
        ...
        <div className={quickPanelBodyClass}>
          {!completedSale && !hasPendingItems ? (
            <>
              <div className="rounded-none border border-dashed border-[var(--border-soft)] bg-[var(--panel-subtle)] px-3.5 py-3 text-[0.92rem] leading-[1.6] text-[var(--foreground-soft)] [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:col-span-full [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:col-span-full [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:hidden [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:hidden">
                เพิ่มสินค้าในตะกร้าก่อน แล้วค่อยเลือกวิธีชำระเงิน
              </div>
              <div className={`${quickMetricCardClass} [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:col-start-1 [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:col-start-1 [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:row-start-2 [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:row-start-2`}>
                <span className="text-[0.82rem] text-[var(--foreground-soft)] [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:text-[0.76rem] [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:text-[0.76rem]">จำนวนรายการ</span>
                <strong className="mt-1 block text-[1.05rem] leading-[1.1] text-[var(--foreground)] [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:text-[0.95rem] [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:text-[0.95rem]">0 รายการ / 0 ชิ้น</strong>
              </div>
              <div className={`${quickMetricCardClass} [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:col-start-2 [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:col-start-2 [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:row-start-2 [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:row-start-2`}>
                <span className="text-[0.82rem] text-[var(--foreground-soft)] [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:text-[0.76rem] [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:text-[0.76rem]">ยอดสุทธิ</span>
                <strong className="mt-1 block text-[1.05rem] leading-[1.1] text-[var(--foreground)] [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:text-[0.95rem] [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:text-[0.95rem]">{formatBaht(0)}</strong>
              </div>
            </>
          ) : !completedSale && qrPaymentSelected ? (
            <div className="[@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:col-span-full [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:col-span-full">
            ...
            <>
              {completedSale ? (
                <div className={`${quickMetricCardClass} !border-[var(--success-border)] !bg-[var(--success-wash)] [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:col-start-1 [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:col-start-1 [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:row-start-2 [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:row-start-2`}>
                  <span className="text-[0.82rem] text-[var(--foreground-soft)]">วิธีชำระเงิน</span>
                  <strong className="mt-1 block text-[1.05rem] leading-[1.1] text-[var(--success)] [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:whitespace-nowrap [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:text-[0.82rem] [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:leading-[1.05]">
                    {paymentMethodLabel}
                  </strong>
                </div>
              ) : null}
              {paymentMethod === "CASH" && !completedSale && receivedAmount > 0 && (
                <div className="overflow-hidden rounded-none border border-[var(--accent-border)] bg-[var(--accent-surface)] px-3.5 py-3 shadow-[var(--brand-shadow)_0_0_15px] [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:col-start-1 [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:col-start-1 [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:row-start-2 [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:row-start-2 [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:min-h-[62px] [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:px-1.5 [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:py-1.5">
                  <span className="text-[0.82rem] text-[var(--brand-strong)] [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:text-[0.68rem]">เงินทอน</span>
                  <strong className="mt-1 block text-[1.05rem] leading-[1.1] text-[var(--foreground)] [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:mt-0.5 [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:text-[0.8rem]">{formatBaht(changeAmount)}</strong>
                </div>
              )}
              <div className={`${quickMetricCardClass} ${completedSale ? "[@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:col-start-2 [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:col-start-2" : paymentMethod === "CASH" && !completedSale && receivedAmount > 0 ? "[@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:col-start-2 [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:col-start-2" : "[@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:col-start-1 [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:col-start-1"} [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:row-start-2 [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:row-start-2`}>
                <span className="text-[0.82rem] text-[var(--foreground-soft)] [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:text-[0.68rem] [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:text-[0.76rem]">จำนวนรายการ</span>
                <strong className="mt-1 block text-[1.05rem] leading-[1.1] text-[var(--foreground)] [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:mt-0.5 [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:text-[0.76rem] [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:text-[0.92rem] [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:whitespace-nowrap [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:whitespace-nowrap">
                  {billItems.length} รายการ / {itemCount} ชิ้น
                </strong>
              </div>
              <div className={`${quickMetricCardClass} ${completedSale ? "[@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:col-start-3 [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:col-start-3" : paymentMethod === "CASH" && !completedSale && receivedAmount > 0 ? "[@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:col-start-3 [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:col-start-3" : "[@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:col-start-2 [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:col-start-2"} [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:row-start-2 [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:row-start-2`}>
                <span className="text-[0.82rem] text-[var(--foreground-soft)] [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:text-[0.68rem] [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:text-[0.76rem]">ยอดสุทธิ</span>
          ...
          {customerDisplayControl ? <div className="min-w-0 [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:hidden [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:hidden">{customerDisplayControl}</div> : null}
        </div>
      </section>
      </div>
      {selectedBillItem ? (
