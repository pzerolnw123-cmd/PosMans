      ...
      <div className="grid gap-[10px] [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:gap-3 [@media(min-width:1181px)_and_(max-width:1280px)_and_(max-height:720px)_and_(orientation:landscape)]:gap-1.5">
        ...
        {selectedProduct ? (
          <div className={`${studioResponsiveClass.detailHeroGrid} [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:mt-0 [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:grid-cols-[minmax(0,150px)_180px] [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:gap-3 [@media(min-width:1181px)_and_(max-width:1280px)_and_(max-height:720px)_and_(orientation:landscape)]:mt-0 [@media(min-width:1181px)_and_(max-width:1280px)_and_(max-height:720px)_and_(orientation:landscape)]:grid-cols-[minmax(0,1fr)_180px] [@media(width:1280px)_and_(height:720px)_and_(orientation:landscape)]:!grid-cols-[minmax(0,1fr)_180px] [@media(width:1366px)_and_(height:720px)_and_(orientation:landscape)]:!grid-cols-[minmax(0,1fr)_180px] [@media(min-width:1181px)_and_(max-width:1280px)_and_(max-height:720px)_and_(orientation:landscape)]:gap-3`}>
            ...
            <div className={`${studioResponsiveClass.detailSidebar} [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:h-[132px] [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:pt-3 [@media(min-width:1181px)_and_(max-width:1280px)_and_(max-height:720px)_and_(orientation:landscape)]:h-[150px] [@media(min-width:1181px)_and_(max-width:1280px)_and_(max-height:720px)_and_(orientation:landscape)]:pt-2 [@media(width:1366px)_and_(height:720px)_and_(orientation:landscape)]:!h-[150px] [@media(width:1366px)_and_(height:720px)_and_(orientation:landscape)]:!pt-1`}>
              <div className="grid w-full justify-items-center pt-5 max-[720px]:pt-0 [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:pt-0">
                ...
                >
                  <button
                    type="button"
                    className={`${primaryButtonClass} min-h-[40px] w-full rounded-none px-4 text-[0.95rem] disabled:cursor-not-allowed disabled:opacity-50 [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:min-h-[34px] [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:text-[0.78rem] [@media(min-width:1181px)_and_(max-width:1280px)_and_(max-height:720px)_and_(orientation:landscape)]:!min-h-[44px] [@media(min-width:1181px)_and_(max-width:1280px)_and_(max-height:720px)_and_(orientation:landscape)]:text-[0.76rem] [@media(width:1366px)_and_(height:720px)_and_(orientation:landscape)]:!min-h-[44px] [@media(width:1366px)_and_(height:720px)_and_(orientation:landscape)]:text-[0.8rem]`}
          ...
          <div className="mt-3 grid gap-[10px] [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:mt-0 [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:content-start [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:gap-4 [@media(min-width:1181px)_and_(max-width:1280px)_and_(max-height:720px)_and_(orientation:landscape)]:mt-0 [@media(min-width:1181px)_and_(max-width:1280px)_and_(max-height:720px)_and_(orientation:landscape)]:gap-2 [@media(width:1280px)_and_(height:720px)_and_(orientation:landscape)]:flex-1 [@media(width:1280px)_and_(height:720px)_and_(orientation:landscape)]:content-between [@media(width:1280px)_and_(height:720px)_and_(orientation:landscape)]:mb-3 [@media(width:1366px)_and_(height:720px)_and_(orientation:landscape)]:!mt-[12px] [@media(width:1366px)_and_(height:720px)_and_(orientation:landscape)]:flex-1 [@media(width:1366px)_and_(height:720px)_and_(orientation:landscape)]:content-between [@media(width:1366px)_and_(height:720px)_and_(orientation:landscape)]:mb-3 [@media(width:1366px)_and_(height:720px)_and_(orientation:landscape)]:gap-2 [@media(width:1280px)_and_(height:800px)_and_(orientation:landscape)]:flex-1 [@media(width:1280px)_and_(height:800px)_and_(orientation:landscape)]:content-between [@media(width:1280px)_and_(height:800px)_and_(orientation:landscape)]:mb-3">
            ...
            <div className="grid items-stretch gap-[10px] md:grid-cols-2 [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:gap-4 [@media(min-width:1181px)_and_(max-width:1280px)_and_(max-height:720px)_and_(orientation:landscape)]:gap-2 [@media(width:1366px)_and_(height:720px)_and_(orientation:landscape)]:gap-2">
              <div className="flex h-full min-w-0 flex-col gap-2 [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:gap-3 [@media(min-width:1181px)_and_(max-width:1280px)_and_(max-height:720px)_and_(orientation:landscape)]:gap-1.5 [@media(width:1366px)_and_(height:720px)_and_(orientation:landscape)]:gap-1.5">
                <Field label="ราคา" className="[@media(width:1280px)_and_(height:720px)_and_(orientation:landscape)]:-mt-[6px] [@media(width:1366px)_and_(height:720px)_and_(orientation:landscape)]:-mt-[6px] [@media(width:1280px)_and_(height:800px)_and_(orientation:landscape)]:-mt-[6px]">
                  <input
                    ...
                    className="w-full rounded-xl border border-[var(--border)] bg-[var(--field-bg)] px-4 py-3 text-[0.96rem] text-[var(--foreground)] outline-none transition-all focus:border-[var(--brand)] focus:bg-[var(--surface-muted)] focus:shadow-[0_0_0_4px_var(--brand-soft)] [appearance:textfield] [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:h-[38px] [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:px-3 [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:py-2 [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:text-[0.84rem] [@media(min-width:1181px)_and_(max-width:1280px)_and_(max-height:720px)_and_(orientation:landscape)]:h-[40px] [@media(min-width:1181px)_and_(max-width:1280px)_and_(max-height:720px)_and_(orientation:landscape)]:px-3 [@media(min-width:1181px)_and_(max-width:1280px)_and_(max-height:720px)_and_(orientation:landscape)]:py-1.5 [@media(min-width:1181px)_and_(max-width:1280px)_and_(max-height:720px)_and_(orientation:landscape)]:text-[0.82rem] [@media(width:1366px)_and_(height:720px)_and_(orientation:landscape)]:h-[44px] [@media(width:1366px)_and_(height:720px)_and_(orientation:landscape)]:px-3 [@media(width:1366px)_and_(height:720px)_and_(orientation:landscape)]:py-1.5 [@media(width:1366px)_and_(height:720px)_and_(orientation:landscape)]:text-[0.86rem] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                  />
                </Field>
              ...
              <div className="flex h-full flex-col gap-3 rounded-[14px] border border-[var(--border)] [background:var(--panel-elevated)] p-3 [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:gap-3 [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:p-2.5 [@media(min-width:1181px)_and_(max-width:1280px)_and_(max-height:720px)_and_(orientation:landscape)]:gap-1.5 [@media(min-width:1181px)_and_(max-width:1280px)_and_(max-height:720px)_and_(orientation:landscape)]:p-2 [@media(width:1366px)_and_(height:720px)_and_(orientation:landscape)]:gap-1.5 [@media(width:1366px)_and_(height:720px)_and_(orientation:landscape)]:p-2.5">
                <span className="text-[0.92rem] font-semibold text-[var(--eyebrow)] [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:text-[0.78rem] [@media(width:1366px)_and_(height:720px)_and_(orientation:landscape)]:text-[0.82rem]">รูปภาพสินค้า</span>
