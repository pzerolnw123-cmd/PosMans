...
export function ProductDetailPanel({
  ...
  return (
    <section className={detailPanelClass}>
      ...
      {selectedProduct ? (
        <div className="-mt-3 pr-1 max-[720px]:mt-0 max-[720px]:pr-0 [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:mt-0 [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:grid [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:content-start [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:gap-3 [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:pr-0 [@media(min-width:1181px)_and_(max-width:1280px)_and_(max-height:720px)_and_(orientation:landscape)]:mt-0 [@media(min-width:1181px)_and_(max-width:1280px)_and_(max-height:720px)_and_(orientation:landscape)]:pr-0 [@media(width:1280px)_and_(height:720px)_and_(orientation:landscape)]:flex [@media(width:1280px)_and_(height:720px)_and_(orientation:landscape)]:flex-col [@media(width:1280px)_and_(height:800px)_and_(orientation:landscape)]:flex [@media(width:1280px)_and_(height:800px)_and_(orientation:landscape)]:flex-col">

          <div className="mt-3 grid gap-[10px] [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:mt-0 [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:content-start [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:gap-4 [@media(min-width:1181px)_and_(max-width:1280px)_and_(max-height:720px)_and_(orientation:landscape)]:mt-0 [@media(min-width:1181px)_and_(max-width:1280px)_and_(max-height:720px)_and_(orientation:landscape)]:gap-2 [@media(width:1280px)_and_(height:720px)_and_(orientation:landscape)]:flex-1 [@media(width:1280px)_and_(height:720px)_and_(orientation:landscape)]:content-between [@media(width:1280px)_and_(height:720px)_and_(orientation:landscape)]:mb-3 [@media(width:1280px)_and_(height:800px)_and_(orientation:landscape)]:flex-1 [@media(width:1280px)_and_(height:800px)_and_(orientation:landscape)]:content-between [@media(width:1280px)_and_(height:800px)_and_(orientation:landscape)]:mb-3">
            <div className={`${detailFieldRowClass} ${selectedProduct.trackStock ? "[@media(min-width:1181px)_and_(max-width:1280px)_and_(max-height:720px)_and_(orientation:landscape)]:!grid-cols-[minmax(0,1fr)_180px] [@media(width:1280px)_and_(height:720px)_and_(orientation:landscape)]:!grid-cols-[minmax(0,1fr)_180px] [@media(width:1280px)_and_(height:800px)_and_(orientation:landscape)]:!grid-cols-[minmax(0,1fr)_180px]" : ""} [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:gap-x-3 [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:gap-y-3 [@media(min-width:1181px)_and_(max-width:1280px)_and_(max-height:720px)_and_(orientation:landscape)]:gap-x-3 [@media(min-width:1181px)_and_(max-width:1280px)_and_(max-height:720px)_and_(orientation:landscape)]:gap-y-2`}>
            ...
            <div className="grid items-stretch gap-[10px] md:grid-cols-2 [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:gap-4 [@media(min-width:1181px)_and_(max-width:1280px)_and_(max-height:720px)_and_(orientation:landscape)]:gap-2">
              <div className="flex h-full min-w-0 flex-col gap-2 [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)]:gap-3 [@media(min-width:1181px)_and_(max-width:1280px)_and_(max-height:720px)_and_(orientation:landscape)]:gap-1.5">
                <Field label="ราคา" className="[@media(width:1280px)_and_(height:720px)_and_(orientation:landscape)]:-mt-[6px] [@media(width:1280px)_and_(height:800px)_and_(orientation:landscape)]:-mt-[6px]">
                  <input
                    type="number"
                    value={priceInput}
                    min="0"
