...
export function ProductDetailPanel({
  ...
  const detailPanelClass = `workspace-main-scroll grid w-[calc(100%+22px)] content-start gap-[10px] overflow-visible ${studioResponsiveClass.panelSurface} ${studioResponsiveClass.densePanelPadding} ${ipadMiniProductFormClass} [@media(min-width:768px)_and_(max-width:820px)_and_(orientation:portrait)_and_(any-pointer:coarse)]:w-[calc(100%+10px)] [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:w-full [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:overflow-y-auto [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:overflow-x-hidden [@media(min-width:821px)_and_(max-width:1024px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:pr-3 [@media(min-width:1025px)_and_(max-width:1180px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:w-[calc(100%+10px)] [@media(min-width:1181px)_and_(max-width:1366px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:gap-1.5 [@media(min-width:1181px)_and_(max-width:1366px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:px-3.5 [@media(min-width:1181px)_and_(max-width:1366px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:py-3.5 [@media(min-width:1181px)_and_(max-width:1366px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:[&_label]:gap-1.5 [@media(min-width:1181px)_and_(max-width:1366px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:[&_label>span]:text-[0.8rem] [@media(min-width:1181px)_and_(max-width:1366px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:[&_input]:h-[40px] [@media(min-width:1181px)_and_(max-width:1366px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:[&_input]:px-3 [@media(min-width:1181px)_and_(max-width:1366px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:[&_input]:py-1.5 [@media(min-width:1181px)_and_(max-width:1366px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:[&_button:not(.stock-toggle-button)]:min-h-[38px] [@media(min-width:1181px)_and_(max-width:1366px)_and_(orientation:landscape)_and_(any-pointer:coarse)]:[&_button:not(.stock-toggle-button)]:text-[0.82rem] max-[820px]:w-full`;
