        ...
        <div className="relative min-h-0 flex-1">
          ...
          {loading ? (
            ...
            products.map((product) => {
              ...
              const miniProductButtonClass = `${ipadMiniLandscapeClass}:!bottom-[10px] ${ipadMiniLandscapeClass}:!left-auto ${ipadMiniLandscapeClass}:!right-[10px] ${ipadMiniLandscapeClass}:!h-[34px] ${ipadMiniLandscapeClass}:!w-[42px] ${ipadMiniLandscapeClass}:!min-w-[42px] ${ipadMiniLandscapeClass}:!gap-0 ${ipadMiniLandscapeClass}:!px-0`;
              ...
              return (
                ...
                >
                  ...
                  >
                    <BasketIcon />
                    <span className={`sales-product-card-button-label ${ipadMiniLandscapeClass}:hidden`}>เพิ่มตะกร้า</span>
                  </button>
                </article>
              );
            })
