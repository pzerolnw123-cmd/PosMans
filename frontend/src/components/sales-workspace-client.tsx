            ...
            products.map((product) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <BasketIcon />
                    <span className={`sales-product-card-button-label [@media(width:1366px)_and_(height:768px)_and_(orientation:landscape)]:hidden ${ipadMiniSaleProductHideClass}`}>เพิ่มตะกร้า</span>
                  </button>
                </article>
              );
            })
