...
export default async function LoginPage() {
  ...
  return (
    <main className="grid h-dvh overflow-hidden">
      <div className="mx-auto grid h-full w-[min(1400px,calc(100%-32px))] py-3 max-[1180px]:w-[min(100%-24px,100%)] max-[720px]:w-[min(100%-16px,100%)] max-[720px]:py-2">
